...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <a class="btn btn-info text-center  mt-5" href="create.php">+Add Animal</a>
            <div class="row mt-5">
                <?php
                                            ...
                                            <div class="card w-100">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between m-3">
                                                        <a class="btn btn-primary col-5" href="update.php?id='.$value["animal_id"].'">Update</a>
                                                        <a class="btn btn-danger col-5" href="delete.php?id='.$value["animal_id"].'">Delete</a>
                                                    </div>
                                            </div>
                                      </div>';   
                            }
